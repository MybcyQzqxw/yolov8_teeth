...
if __name__ == "__main__":
    ...
    # 先读取COCO文件，提取类别名
    with open('instances_train2017.json', 'r', encoding='utf-8') as f:
        coco = json.load(f)
    categories = coco['categories']
    names = [cat['name'] for cat in categories]
    nc = len(names)

    convert_coco_to_yolo('instances_train2017.json', 'yolo/labels_train2017')

    # 自动生成dataset.yaml
    yaml_content = 'train: ./yolo/images/train\nval: ./yolo/images/val\n\n'
